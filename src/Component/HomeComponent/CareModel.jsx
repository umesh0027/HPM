...
const CareModel = () => {
  ...
  Health Ease Model of Care
        ...
        <div className='flex flex-col mx-auto md:w-4/5 lg:w-3/5 xl:w-4/5 mt-20 mb-10'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mx-6 lg:mx-auto'>
                {images1.map((item, index) => (
                    <div key={index} className='group relative cursor-pointer hover:scale-105 transition-transform'>
                        <img className=' h-full rounded-lg hover:scale-105 transition-transform' src={item.img} alt={item.imageTitle} />
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 mx-6 lg:mx-auto'>
